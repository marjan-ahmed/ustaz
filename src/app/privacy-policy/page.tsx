        ...
        <div className="max-w-4xl mx-auto px-6 py-12 sm:py-16">
          ...
          <article id="privacy-article" className="prose prose-slate max-w-none prose-headings:scroll-mt-24 prose-h2:text-2xl prose-h2:font-bold prose-h2:mt-12 prose-h2:mb-3 prose-h3:text-lg prose-h3:font-semibold prose-h3:mt-6 prose-h3:mb-2 prose-p:leading-7 prose-li:leading-7">
            ...
            <p>
              ...
              you of new Service Requests, status changes, and chat messages &mdash; even when the
            ...
            <ul>
              ...
              <li><strong>Google Maps Platform</strong> &mdash; geocoding addresses, displaying maps.</li>
              <li><strong>Firebase Cloud Messaging</strong> &mdash; push notification delivery.</li>
              <li><strong>Vercel</strong> &mdash; web application hosting.</li>
              <li><strong>JazzCash / EasyPaisa / partner banks</strong> &mdash; for Provider wallet top-up settlement.</li>
            </ul>
            <p>
